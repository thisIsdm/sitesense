            ...
            <div className="bg-white p-8 rounded-lg border shadow-sm">
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Please wait while we upload your files...</p>
                </div>
                <div className="w-full">
                  <Progress value={uploadProgress} className="w-full" />
                  <p className="text-xs text-gray-500 mt-2 text-center">{uploadProgress}% Complete</p>
                </div>
              </div>
            </div>
      </div>
          ...
          {showAlert && (
            ...
            <div className="text-center mb-8">
              <div className="flex justify-center mb-4">
                <Image src="/logo.png" alt="SiteSenseAI" width={400} height={80} />
              </div>
              <p className="text-gray-600">Turn site images into actionable insights</p>
            </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                ...
                <div>
                  <p className="text-lg font-medium text-gray-900">
                    ...
                    <button onClick={() => fileInputRef.current?.click()} className="text-[#AE4B4B] hover:underline">
                      browse
                    </button>
                  </p>
                  <p className="text-sm text-gray-500 mt-2">
                    Upload your image or video in jpeg, png, or mp4
                    <br />
                    Maximum file size: 50 MB
                  </p>
                </div>
                <Button onClick={() => fileInputRef.current?.click()} className="bg-[#AE4B4B] hover:bg-[#AE4B4B]/90">
