      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <main className="container mx-auto px-4 py-8 flex-grow">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">Please upload and process some files first.</p>
            <Button onClick={handleNewUpload}>Start New Upload</Button>
          </div>
        </main>
        <Footer />
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex space-x-4">
              <Button variant="outline" onClick={handleConfigureAgain}>
                Configure Again
              </Button>
          ...
          <div className="bg-white rounded-lg p-6 border">
            <h2 className="text-xl font-semibold mb-6">
              Processing Results for {currentFile.fileName}
            </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-600">
                    Drag the slider to compare original vs processed image
                  </p>
                </div>
              </div>
            ) : (
            ...
            <div className="mt-8 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="font-medium">File Type:</span> {currentFile.type}
                </div>
                <div>
                  <span className="font-medium">File Size:</span> {(currentFile.fileSize / 1024 / 1024).toFixed(2)} MB
                </div>
                <div>
                  <span className="font-medium">Detected Objects:</span> {currentResult.objectTypes.join(', ')}
                </div>
                <div>
                  <span className="font-medium">Processed At:</span> {new Date(currentResult.timestamp).toLocaleString()}
                </div>
              </div>
            </div>
          </div>
